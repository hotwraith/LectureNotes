...
\item constante de Faraday 96'485 $C\cdot mol^{-1}$ (charge d’une mole d'électrons)
\end{itemize}
...
%TODO I'm not even sure what to add here, is there any point to add more than the résumé ?
\subsection{Résumé}
