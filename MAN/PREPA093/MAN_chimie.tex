...
\paragraph{La synthèse de l'ammoniac} À température ambiante l'équilibre de la réaction de synthèse de l'ammoniac \(N_2(g) + 3H_2(g) \leftrightarrow 2NH_3(g)\) est favorable au \textbf{produits} mais la vitesse de réaction est très lente. \par
